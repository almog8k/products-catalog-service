...
export class migrations1716232286475 implements MigrationInterface {
    name = 'migrations1716232286475'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "conversion_rates_usd" ADD "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "updated_at"`);
